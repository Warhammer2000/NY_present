document.addEventListener("DOMContentLoaded", () => {
  ...
  // Скрываем секцию на мобильных устройствах при загрузке
  if (isMobile()) {
  ...
  let currentBackground = null; // Переменная для хранения текущего фона
  let comicElements = []; // Переменная для хранения элементов текущей страницы
  ...
  function loadPage() {
      ...
      comicElements = currentPage.elements;
  }
